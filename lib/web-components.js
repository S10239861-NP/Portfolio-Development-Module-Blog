...
import { redirectTo } from "../lib/utils.js";
...
class BlogShell extends HTMLElement
{
    ...
    onHomeButtonMouseDown()
    {
        ...
        // redirectTo("./experimental/index.html");
    }
    ...
    onBlogButtonMouseDown()
    {
        ...
        // redirectTo("./experimental/blog-page/main.html");
    }
    ...
    onContactButtonMouseDown()
    {
        ...
        // redirectTo("./experimental/contact-page/main.html");
    }
